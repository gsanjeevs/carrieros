...
export const ROLE_CAPABILITIES: Record<string, RoleCapability[]> = {
  ...
  sx_owner: ['admin', 'admin_billing', 'admin_flags', 'admin_impersonate', 'admin_support'],
