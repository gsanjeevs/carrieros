...
export type RoleCapability = 'admin' | 'admin_billing' | 'admin_flags' | 'admin_impersonate' | 'chat_participate' | 'customers_manage' | 'dashboard' | 'dispatch' | 'documents_read' | 'documents_send' | 'documents_upload' | 'driver_profile_edit_own' | 'drivers' | 'drivers_manage' | 'dvir_attach_any' | 'dvir_file' | 'finance' | 'fuel_log' | 'ifta_record' | 'invoice_actions' | 'load_intake_extract' | 'loads_advance_status' | 'loads_manage' | 'location_share' | 'my_loads' | 'problem_report' | 'service_log' | 'settlements_manage' | 'subscription_management' | 'team' | 'team_manage' | 'vehicles_manage'

export const ROLE_CAPABILITIES: Record<string, RoleCapability[]> = {
  dispatcher: ['chat_participate', 'customers_manage', 'dashboard', 'dispatch', 'documents_read', 'documents_send', 'documents_upload', 'drivers', 'fuel_log', 'ifta_record', 'load_intake_extract', 'loads_advance_status', 'loads_manage'],
  driver: ['chat_participate', 'dashboard', 'documents_read', 'documents_upload', 'driver_profile_edit_own', 'dvir_file', 'fuel_log', 'ifta_record', 'loads_advance_status', 'location_share', 'my_loads', 'problem_report'],
  finance: ['dashboard', 'documents_read', 'finance', 'invoice_actions', 'settlements_manage'],
  owner: ['chat_participate', 'customers_manage', 'dashboard', 'dispatch', 'documents_read', 'documents_send', 'documents_upload', 'drivers', 'drivers_manage', 'dvir_attach_any', 'dvir_file', 'finance', 'fuel_log', 'ifta_record', 'invoice_actions', 'load_intake_extract', 'loads_advance_status', 'loads_manage', 'location_share', 'my_loads', 'problem_report', 'service_log', 'settlements_manage', 'subscription_management', 'team', 'team_manage', 'vehicles_manage'],
  solo: ['chat_participate', 'customers_manage', 'dashboard', 'dispatch', 'documents_read', 'documents_send', 'documents_upload', 'driver_profile_edit_own', 'drivers', 'drivers_manage', 'dvir_attach_any', 'dvir_file', 'finance', 'fuel_log', 'ifta_record', 'invoice_actions', 'load_intake_extract', 'loads_advance_status', 'loads_manage', 'location_share', 'my_loads', 'problem_report', 'service_log', 'settlements_manage', 'subscription_management', 'team', 'team_manage', 'vehicles_manage'],
