...
export const ROLE_CAPABILITIES: Record<string, RoleCapability[]> = {
  ...
  sx_owner: ['admin', 'admin_ai_config', 'admin_billing', 'admin_flags', 'admin_impersonate', 'admin_support'],
  sx_support: ['admin', 'admin_impersonate', 'admin_support'],
}
