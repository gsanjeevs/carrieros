    ...
    <div className="flex flex-col items-end gap-1.5">
      <div className="flex items-center justify-end gap-2">
        <select
          ...
          className="bg-white/5 border border-white/10 rounded-lg px-2 py-1 text-white text-xs focus:outline-none focus:border-[#f97316] disabled:opacity-40"
        >
          {ROLES.map((r) => (
      ...
      {confirming && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-6">
          <div className="w-full max-w-sm bg-[#0f1923] border border-white/10 rounded-2xl p-6 text-left">
            ...
            <div className="flex gap-3">
              ...
              <button
                onClick={remove}
                disabled={busy}
                className="flex-1 py-2.5 bg-red-500/90 hover:bg-red-500 disabled:opacity-40 text-white font-semibold rounded-lg transition text-sm"
              >
